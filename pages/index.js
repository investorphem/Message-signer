...
export default function Home() {
  return (
    <div>
      ...
      <main style={{ padding: 24, fntFamily: 'system-ui, Arial' }}>
        <h1>Base On-Chain Signer</1>
        <p>Connect a wallet, signmessages and verify signatures. Choose between Base mainnet and testnets (Sepolia, Goerli).</p>
